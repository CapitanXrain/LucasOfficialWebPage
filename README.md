...
< PROJECT ROOT >
   |
   |-- core/                               # Implements app configuration | Implementa la configuración de la aplicación
   |    |-- settings.py                    # Defines Global Settings
   |    |-- wsgi.py                        # Start the app in production
   |    |-- urls.py                        # Define URLs served by all apps/nodes | Definir las direcciones URL servidas por todas las aplicaciones o nodos
   |
   |-- apps/
   |    |
   |    |-- home/                          # A simple app that serve HTML files | Una aplicación sencilla que sirve archivos HTML
